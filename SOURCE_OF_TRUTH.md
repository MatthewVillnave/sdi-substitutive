...
- **SOT version / state label:** v2 (post-31BT, SOT-01 hardened, post-31CD Option A real-activation micro-probe PASSED, committed and pushed; post-31CE Option A 9-pair matrix PASSED, committed and pushed; post-31CF Option B BLOCKED as `BLOCKED_31CF_HOOK_POINT_AMBIGUOUS` (no source patch, no build, no capture; this SOT entry is future-stable and does not require a post-commit sync))
- **Last verified commit:** `82b1d91c1554645e9cc64a6f705903b897d0f011` (Phase 31CE: extend Option A real-activation proxy replay, classification `PASS_31CE_REAL_ACTIVATION_OPTION_A_MULTIPROMPT_MULTILAYER_CLEAN`). 31CE main commit (and current `origin/master` HEAD): `82b1d91c1554645e9cc64a6f705903b897d0f011`. 31CD main commit: `01c20b1058cf69dce05b08366a9bf1f2711ec8f5`. 31CD SOT-sync follow-up: `32f030a0d2f9f4a9f208bb6fd653540e3e61ad5c`. 31CC commit: `dbd10c722264cca0cdaec3a63b1532a324dad034`. 31CB commit: `c93bcdf96c8422f91f01fbc8c4e522710922fe61`. 31CF is recorded as BLOCKED in this phase.
