...
- **SOT version / state label:** v2 (post-31BT, SOT-01 hardened, post-31CD Option A real-activation micro-probe passed; SOT edit uncommitted, pending Matt approval)
- **Last verified commit:** `c93bcdf96c8422f91f01fbc8c4e522710922fe61` (Phase 31CB: clean stale phase provenance artifacts). Phase 31CD is **uncommitted** at this point — the working tree contains 31CD artifacts (runner, result JSON, doc, SOT edits) but no commit has been made.
